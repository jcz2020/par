...
let test_openai_create_rejects_empty_api_key () =
  match Openai_provider.create
    (Openai { api_key = ""; base_url = None; organization = None; embedding_model = None; prompt_cache_key = None }) with
...
let test_openai_create_accepts_valid_api_key () =
  match Openai_provider.create
    (Openai { api_key = "sk-valid"; base_url = None; organization = None; embedding_model = None; prompt_cache_key = None }) with
  | Ok _ -> ()
