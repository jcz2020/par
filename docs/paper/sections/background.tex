...
Recent work on effect handlers~\cite{effect-handlers-survey} demonstrates how algebraic effects can model concurrent agent computations, offering a typed account of effectful computation with a different emphasis: effect typing rather than state-transition guarantees.
