...
agent execution.  Formally, let $\identifiable$ be the set of conversational
...
\onAfterTool &\colon& \call \times \result \to \result\ \maybe \\
\onError &\colon& \error \to \result\ \maybe
\end{array}
\]
