...
- [Streaming API](https://github.com/jcz2020/par/blob/main/sdk/streaming.md) for the incremental chunk delivery path (v0.5.3 background-thread + queue model)
- [Concurrency how-to](https://github.com/jcz2020/par/blob/main/howto/concurrency.md) for practical patterns: timeouts, parallel tools, cancellation
