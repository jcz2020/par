...
| [Prompt Caching](sdk/prompt_caching.md) | Cache system prompts and repeated context to reduce latency and cost |
| [Content Blocks](sdk/content_blocks.md) | Structured content blocks for multimodal and typed message parts |
